...
|_PiHostName_|rpi3vm64-000|Raspberry Pi OS の host 名です。[Raspberry Pi OS の初期設定を行う](config-rpi.md)で参照します。|
...
```bash
# Download host kit
curl https://github.com/Akinori-Furuta/qemu-raspberrypi/tree/master/downloads/rpios32bit-host-kit.tar.gz
# Download target kit, keep .tar.gz archive
curl https://github.com/Akinori-Furuta/qemu-raspberrypi/tree/master/downloads/rpios32bit-target-kit.tar.gz
...
```bash
# Download host kit
curl https://github.com/Akinori-Furuta/qemu-raspberrypi/tree/master/downloads/rpios64bit-host-kit.tar.gz
